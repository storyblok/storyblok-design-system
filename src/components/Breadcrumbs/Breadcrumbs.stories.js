...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Breadcrumbs show users their current location relative to the information architecture and enable them to quickly move up to a parent level or previous step.'
      }
    }
  },
  args: {
...
WithLargeSection.parameters = {
  docs: {
    description: {
      story: 'When you set the attribute `isLargeSection`, the last item will be show in a new line'
    }
  }
}

export const LongBreadcrums = Template.bind({})
...
LongBreadcrums.parameters = {
  docs: {
    description: {
      story: 'When a path contains more than five levels of entities, it should have a `SbDropdown` with the rest of the items'
    }
  }
}
